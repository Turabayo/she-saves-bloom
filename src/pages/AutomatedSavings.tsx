                  ...
                  <Card key={saving.id} className="p-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                      <div>
                        ...
                        <div className="font-medium capitalize">{saving.frequency}</div>
                      </div>
                      <div>
                        <span className="text-muted-foreground">Next execution:</span>
                        <div className="font-medium">{formatDate(saving.next_execution_date)}</div>
                      </div>
                      <div>
                        <span className="text-muted-foreground">Created:</span>
                        <div className="font-medium">{formatDate(saving.created_at)}</div>
                      </div>
                    </div>
                  </Card>
                );
          ...
          <Card className="p-6">
            ...
            <div className="space-y-3">
              {upcomingSavings.map((saving) => {
                const relatedGoal = goals.find(goal => goal.id === saving.goal_id);
                return (
                  <div key={saving.id} className="flex justify-between items-center p-3 bg-secondary/50 rounded-lg">
                    <div>
